...
import Framework.FunctionLibrary.CheckoutFunctionalityLib;
...
public class CheckOutFunctionalityTest {
    ...
    public CheckoutFunctionalityLib checkout;
...
public  void beforeClass() {
   ...
   @Test
    public void cartFunctionality() throws InterruptedException{
	   test= extentReports.createTest("CheckoutFunctionality");
       checkout= new CheckoutFunctionalityLib(driver);
	   checkout.verifyCheckoutFunctionality();
   }
   ...
   public void getResult(ITestResult result) throws IOException {
   	if(result.getStatus()==ITestResult.FAILURE) {
   		...
   		String screenShot= CheckOutFunctionalityTest.getScreenshot(driver,result.getName());
